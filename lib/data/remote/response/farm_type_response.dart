...
class FarmTypeResponse {
  ...
  FarmTypeResponse.fromJson(Map<String, dynamic> json) {
...
extension FarmTypeResponseMapper on FarmTypeResponse {
  List<FarmTypeEntity> toEntity() {


    return body?.map((body) => FarmTypeEntity(name: body.name ?? "", id: body.id?.toString() ?? "")).toList() ?? [];
