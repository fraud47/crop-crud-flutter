...
abstract class $SignUpResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? name, String? email, String? error});
}
...
class _$SignUpResponseImpl extends _SignUpResponse {
  const _$SignUpResponseImpl({this.id, this.name, this.email, this.error})
      : super._();
  ...
  @override
  String toString() {
    return 'SignUpResponse(id: $id, name: $name, email: $email, error: $error)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, email, error);
