...
class _$SignUpImpl implements _SignUp {
  const _$SignUpImpl({this.id, this.name, this.email});
  ...
  @override
  String toString() {
    return 'SignUp(id: $id, name: $name, email: $email)';
  }
...
abstract class _SignUp implements SignUp {
  const factory _SignUp(
      {final int? id, final String? name, final String? email}) = _$SignUpImpl;
